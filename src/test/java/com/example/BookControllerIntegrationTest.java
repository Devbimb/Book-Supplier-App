...
public class BookControllerIntegrationTest {
	...
	private final Book TEST_BOOK = new Book(null, "science", "Send Down the Rain", "Chinua Achebe", "Oxford",
			"second", 3, "Novel", "Donated", "Individual", "Wood", "UK", 124563, "Wornout", "repaired", null);
	
	private final Book TEST_SAVED_BOOK = new Book(1L, "science", "Send Down the Rain", "Chinua Achebe","Oxford",
	         "second", 3, "Novel", "Donated", "Individual", "Wood", "UK", 124563, "Wornout", "repaired", null);
...
public void testReadAll() throws Exception {
    final List<Book> PEOPLE = new ArrayList<>();
    PEOPLE.add(TEST_SAVED_BOOK);

    final String resultString = this.mockMVC
            .perform(request(HttpMethod.GET, "/book/readAll").accept(MediaType.APPLICATION_JSON))
...
public void testUpdate() throws Exception {
    final Book newBook = new Book(null, "science", "Send Down the Rain", "Chinua Achebe", "Oxford",
			"second", 3, "Novel", "Donated", "Individual", "Wood", "UK", 124563, "Wornout", "repaired", null);
    String resultString = this.mockMVC
            .perform(put("/book/update/3").contentType(MediaType.APPLICATION_JSON)
...
public void testDelete() throws Exception {
    this.mockMVC.perform(delete("/book/delete/2")).andExpect(status().isNoContent());
}

}

//check BookControllerIntegrationTest for other Test example